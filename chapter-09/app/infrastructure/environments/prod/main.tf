/**
 * Zero Trust Payment Processing - Production Environment
 */
...
module "networking" {
  ...
  enable_vpc_service_controls = true  # Enabled for production environment
...
module "database" {
  ...
  db_tier         = "db-custom-4-15360"  # Larger instance for production
